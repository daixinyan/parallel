...
export OMP_NUM_THREADS=4	# set max number of threads OpenMP can use per MPI task
...
time mpiexec -ppn $NUM_MPI_PROCESS_PER_NODE ./MS_Hybrid_dynamic1 $OMP_NUM_THREADS -2 2 -2 2 600 600 disable  # edit this line to fit your needs!
