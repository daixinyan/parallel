...
cd $PBS_O_WORKDIR
NUM_MPI_PROCESS_PER_NODE=12	# edit this line to set number of MPI process you want to use per node
export OMP_NUM_THREADS=1	# set max number of threads OpenMP can use per MPI task
...
time mpiexec -ppn $NUM_MPI_PROCESS_PER_NODE ./MS_MPI_dynamic5 $OMP_NUM_THREADS -2 2 -2 2 1200 1200 disable  # edit this line to fit your needs!
